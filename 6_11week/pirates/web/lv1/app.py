...
client = MongoClient("mongodb+srv://sparta:test@cluster0.hep0ed2.mongodb.net/?retryWrites=true&w=majority")
...
def post_exhibit():
    ...
    period = soup.select_one('#container > div.wide-inner > section > div.post-element > span').text.strip()
